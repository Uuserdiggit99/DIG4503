...
axios("https://pokeapi.co/api/v2/pokemon/necrozma")//This is an HTTP Promise. Once Axios fulfills the promise by accessing the link, the Then method will execute.
    ...
    })//This parenthesis closes the Then method. 
    
    .catch(function(error){//If the Then method is unable to execute(the promise is unfulfilled ), this Catch method  will run instead.
        ...
        */
    })/*This parenthesis ends the Catch method*/;/*This semicolon ends/closes all methods and activities related to the Axios promise*/ 
